...
public partial class EvidenciaFotograficaUbr
{
    public int IdEvidenciaFotografica { get; set; }
    ...
    public int? NumeroUbrsmes { get; set; }

    public int? Ubrssupervisadasmes { get; set; }

    public int? Crismes { get; set; }

    public int? CrismesSupervisadas { get; set; }
